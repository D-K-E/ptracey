...
public:
  ...
  virtual bool
  bounding_box(double _time0, double _time1,
...
bool moving_sphere::bounding_box(double _time0,
                                 double _time1,
...
bool moving_sphere::hit(const ray &r, double t_min,
                        double t_max,
