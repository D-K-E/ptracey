...
model_random_material(matrix modelMat,
  ...
  spectrum rcolor = spectrum(spectrum::random());
  ...
  for (int a = -11; a < 11; a++) {
    for (int b = -11; b < 11; b++) {
      ...
      if ((center - vec3(4, 0.2, 0)).length() > 0.9) {
        ...
        if (choose_mat < 0.8) {
          // diffuse
          spectrum randcol1 = spectrum(color::random());
          spectrum randcol2 = spectrum(color::random());
          spectrum albedo = spectrum(color::random());
          sphere_material =
              make_shared<lambertian>(spectrum(albedo));
          auto center2 =
          ...
          // metal
          auto albedo = spectrum(spectrum::random(0.5, 1));
